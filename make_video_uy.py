...
max_and_min_data_file = 'max_and_min_uy.txt'
max_uy, min_uy = np.genfromtxt(max_and_min_data_file, unpack=True)
...
def animate(i):
    ...
    #plt.ylim((0, 0.1))
    ax.set_zlabel('T')
    ax.set_zlim(min_uy*1.01, max_uy*1.01)
    #plt.clim((min_uy*1.01, max_uy*1.01))
    return ax
